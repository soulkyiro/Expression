...
public class ExpressionEvaluatorTest {
    ...
    public void subIntegerIntegerExpressionTest() {
        assertEquals(0, new Substract(new Constant(2), new Constant(2)).evaluator());
        assertEquals(-10, new Substract(new Constant(5), new Constant(15)).evaluator());
        assertEquals(220, new Substract(new Constant(220), new Constant(0)).evaluator());
    }

    @Test
    public void subDoubleIntegerExpressionTest() {
        assertEquals(0.2, (double) new Substract(new Constant(2.2), new Constant(2)).evaluator(), 0.1);
        assertEquals(-9.6, new Substract(new Constant(5.4), new Constant(15)).evaluator());
        assertEquals(220.9, new Substract(new Constant(220.9), new Constant(0)).evaluator());
    }

    @Test
    public void subIntegerDoubleExpressionTest() {
        assertEquals(-0.2, (double) new Substract(new Constant(2), new Constant(2.2)).evaluator(), 0.1);
        assertEquals(9.6, new Substract(new Constant(15), new Constant(5.4)).evaluator());
        assertEquals(-220.9, new Substract(new Constant(0), new Constant(220.9)).evaluator());
    }

    @Test
    public void subDoubleDoubleExpressionTest() {
        assertEquals(-0.6, (double) new Substract(new Constant(2.2), new Constant(2.8)).evaluator(), 0.1);
        assertEquals(-10.2, new Substract(new Constant(5.4), new Constant(15.6)).evaluator());
    }
